...
reader = Reader('c:/Users/geun/KoreanNewsChronicle/Data/2020(1_10).csv')

file = open("c:/Users/geun/KoreanNewsChronicle/PreProcess/한국어불용어100.txt", 'r', encoding="utf-8")
stopword=[]
...
file = open("20200101-20200131_topic_extract.csv", "w", encoding='utf-8', newline = '')
writer = csv.writer(file)
writer.writerow(['index', 'topics'])
for i, line in enumerate(open("c:/Users/geun/KoreanNewsChronicle/PreProcess/datas.txt", encoding='utf-8')): #해당 경로의 파일을 받아와 한 라인씩 model에 추가
